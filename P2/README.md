...
* Feedback grid
![Feedback grid](./feedback_capture_grid.png)
...
* Hemos creado un User flow para demostrar las interacciones y el flujo de interacción que planteamos para que sea seguido por los usuarios al entrar en la web y comenzar a explorarla:
  
![User Flow](./user_flow_v1.png)



### ARQUITECTURA DE INFORMACIÓN
* Hemos creado una arquitectura de información para representar la estructura de la web: contamos además del index con archivos html para localización del restaurante, los productos de Goikocina, creación de cuenta/inicio de sesión, información de la cuenta, reservaciones y pedidos.
![Arquitectura de información](./Arquitectura_de_informacion_v1.png)


### Prototipo Lo-FI Wireframe 

* ![Wireframe landing](./wireframe_landing.jpeg)
* ![Wireframe comentarios](./wireframe_paginaUsuario.jpeg)
